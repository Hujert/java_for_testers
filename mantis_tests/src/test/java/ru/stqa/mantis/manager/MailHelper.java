...
public class MailHelper extends HelperBase {
    ...
    public static Folder getInbox(String email, String password) {
        try {
    ...
    public String getUrlFromMail(String username, String password) {
        var messages = manager.mail().receive(username, password, Duration.ofSeconds(60));
